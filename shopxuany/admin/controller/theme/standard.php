<?php
namespace Opencart\Admin\Controller\Extension\shopxuany\Theme;
...
class Standard extends \Opencart\System\Engine\Controller
{
    public function index(): void
    {
        ...
        $this->load->language('extension/shopxuany/theme/standard');
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/shopxuany/theme/standard', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id']),
        ];

        $data['save'] = $this->url->link('extension/shopxuany/theme/standard|save', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $this->request->get['store_id']);
        ...
        $this->response->setOutput($this->load->view('extension/shopxuany/theme/standard', $data));
    }
    ...
    public function save(): void
    {
        ...
        if (!$this->user->hasPermission('modify', 'extension/shopxuany/theme/standard')) {
    ...
    public function install(): void
    {
        if ($this->user->hasPermission('modify', 'extension/shopxuany/theme/standard')) {
            ...
            $startup_data = [
                'code' => 'theme_standard',
                'action' => 'catalog/extension/shopxuany/startup/standard',
                'status' => 1,
                'sort_order' => 2,
            ];
